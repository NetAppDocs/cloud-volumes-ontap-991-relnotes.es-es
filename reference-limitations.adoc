...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Descubra cómo usar Cloud Backup para realizar backups y restaurar los datos de ONTAP"^].
