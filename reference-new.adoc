...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/whats-new.html["Más información sobre las novedades de BlueXP"^].
...
El rendimiento de Cloud Volumes ONTAP se ha mejorado cuando https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-write-speed.html["alta velocidad de escritura"^] está habilitado en un tipo de instancia compatible.
